 ...
 */
public class DeRegisterRequest extends AbstractMessage{
    ...
    public int getMessageType() {
        return Constants.DEREG_REQ_MESSAGE_TYPE;
    }
    ...
    public void parse(DataInput dataInput) throws MessageProcessingException {
        try {
            ...
            throw new MessageProcessingException("Can not read from data in ", e);
        }
    }
